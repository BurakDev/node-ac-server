...
var wasmBinaryFile = 'aclibrary.wasm';
...
var real__genpwdhash = asm["_genpwdhash"];
asm["_genpwdhash"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__genpwdhash.apply(null, arguments);
};
...
var _genpwdhash = Module["_genpwdhash"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_genpwdhash"].apply(null, arguments)
};
